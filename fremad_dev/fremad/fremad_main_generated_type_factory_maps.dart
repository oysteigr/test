library fremad.web.fremad_main.generated_type_factory_maps;
...
final Map<Type, Function> typeFactories = <Type, Function>{
  import_0.FremadUrlRewriter: () => new import_0.FremadUrlRewriter(),
  import_0.HeaderComponent: () => new import_0.HeaderComponent(),
  import_0.MainMenuComponent: () => new import_0.MainMenuComponent(),
  import_0.FooterComponent: () => new import_0.FooterComponent(),
  import_0.ShowTheClubComponent: () => new import_0.ShowTheClubComponent(),
  import_0.ShowHomeComponent: () => new import_0.ShowHomeComponent(),
  import_0.ShowLogginComponent: () => new import_0.ShowLogginComponent(),
  import_0.ShowSponsorsComponent: () => new import_0.ShowSponsorsComponent(),
  import_0.ShowTeamComponent: () => new import_0.ShowTeamComponent(),
  import_0.ShowAdminComponent: () => new import_0.ShowAdminComponent(),
  import_0.FrontArticleListComponent: () => new import_0.FrontArticleListComponent(),
  import_0.FrontArticleComponent: () => new import_0.FrontArticleComponent(),
  import_0.ShowTeamAboutComponent: () => new import_0.ShowTeamAboutComponent(),
  import_0.ShowTeamPlayersComponent: () => new import_0.ShowTeamPlayersComponent(),
  import_0.ShowTeamFixtureComponent: () => new import_0.ShowTeamFixtureComponent(),
  import_0.ShowTeamTableComponent: (a1) => new import_0.ShowTeamTableComponent(a1),
  import_0.ShowAdminArticlesComponent: () => new import_0.ShowAdminArticlesComponent(),
  import_0.ShowAdminPlayersComponent: () => new import_0.ShowAdminPlayersComponent(),
  import_0.ShowAdminMatchesComponent: () => new import_0.ShowAdminMatchesComponent(),
  import_0.ShowAdminTeamsComponent: (a1) => new import_0.ShowAdminTeamsComponent(a1),
  import_0.Messages: (a1) => new import_0.Messages(a1),
...
final Map<Type, List<Key>> parameterKeys = {
  ...
  import_0.ShowTeamTableComponent: [_KEY_Http],
  ...
  import_0.ShowAdminTeamsComponent: [_KEY_Http],
  import_0.Messages: [_KEY_RootScope],
