library fremad.web.fremad_main.generated_expressions;
...
final Map<String, FieldGetter> getters = {
  ...
  r"tableEntryListe": (o) => o.tableEntryListe,
  r"entry": (o) => o.entry,
  r"teamName": (o) => o.teamName,
  r"teamList": (o) => o.teamList,
  r"team": (o) => o.team,
  r"id": (o) => o.id,
  r"onlineId": (o) => o.onlineId,
  r"selectTeam": (o) => o.selectTeam,
  r"isActive": (o) => o.isActive,
  r"update": (o) => o.update,
  r"delete": (o) => o.delete,
  r"setEditingMode": (o) => o.setEditingMode,
  r"isAdding": (o) => o.isAdding,
  r"add": (o) => o.add,
  r"cancel": (o) => o.cancel
};
final Map<String, FieldSetter> setters = {
  ...
  r"tableEntryListe": (o, v) => o.tableEntryListe = v,
  r"entry": (o, v) => o.entry = v,
  r"teamName": (o, v) => o.teamName = v,
  r"teamList": (o, v) => o.teamList = v,
  r"team": (o, v) => o.team = v,
  r"id": (o, v) => o.id = v,
  r"onlineId": (o, v) => o.onlineId = v
};
