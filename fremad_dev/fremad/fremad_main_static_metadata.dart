library fremad.web.fremad_main.generated_metadata;
...
final Map<Type, Object> typeAnnotations = {
  import_0.FremadUrlRewriter: const [
    const import_1.Injectable(),
  ],
  import_0.HeaderComponent: const [
    const import_2.Component(selector: 'header-item', publishAs: 'ctrl', templateUrl: 'packages/fremad/components/header.html', useShadowDom: false),
  ],
  import_0.MainMenuComponent: const [
    const import_2.Component(selector: 'main-menu', publishAs: 'ctrl', templateUrl: 'packages/fremad/components/main_menu.html', useShadowDom: false),
  ],
  import_0.FooterComponent: const [
    const import_2.Component(selector: 'footer-item', publishAs: 'ctrl', templateUrl: 'packages/fremad/components/footer.html', useShadowDom: false),
  ],
  import_0.ShowTheClubComponent: const [
    const import_2.Component(selector: 'club-view', publishAs: 'ctrl', templateUrl: 'packages/fremad/components/club_view.html', useShadowDom: false),
  ],
  import_0.ShowHomeComponent: const [
    const import_2.Component(selector: 'home-view', publishAs: 'ctrl', templateUrl: 'packages/fremad/components/home_view.html', useShadowDom: false),
  ],
  import_0.ShowLogginComponent: const [
    const import_2.Component(selector: 'loggin-view', publishAs: 'ctrl', templateUrl: 'packages/fremad/components/loggin_view.html', useShadowDom: false),
  ],
  import_0.ShowSponsorsComponent: const [
    const import_2.Component(selector: 'sponsors-view', publishAs: 'ctrl', templateUrl: 'packages/fremad/components/sponsors_view.html', useShadowDom: false),
  ],
  import_0.ShowTeamComponent: const [
    const import_2.Component(selector: 'team-view', publishAs: 'ctrl', templateUrl: 'packages/fremad/components/team_view.html', useShadowDom: false),
  ],
  import_0.ShowAdminComponent: const [
    const import_2.Component(selector: 'admin-view', templateUrl: 'packages/fremad/components/admin_view.html', cssUrl: 'packages/fremad/components/admin_view.css', useShadowDom: false),
  ],
  import_0.FrontArticleListComponent: const [
    const import_2.Component(selector: 'front-article-list', templateUrl: 'packages/fremad/components/front/front_article_list.html', cssUrl: 'packages/fremad/components/front/front_article_list.css', useShadowDom: false),
  ],
  import_0.FrontArticleComponent: const [
    const import_2.Component(selector: 'front-article', templateUrl: 'packages/fremad/components/front/front_article.html', cssUrl: 'packages/fremad/components/front/front_article.css', useShadowDom: false),
  ],
  import_0.ShowTeamAboutComponent: const [
    const import_2.Component(selector: 'team-about-view', templateUrl: 'packages/fremad/components/team/about_view.html', useShadowDom: false),
  ],
  import_0.ShowTeamPlayersComponent: const [
    const import_2.Component(selector: 'team-players-view', templateUrl: 'packages/fremad/components/team/players_view.html', useShadowDom: false),
  ],
  import_0.ShowTeamFixtureComponent: const [
    const import_2.Component(selector: 'team-fixture-view', templateUrl: 'packages/fremad/components/team/fixture_view.html', useShadowDom: false),
  ],
  import_0.ShowTeamTableComponent: const [
    const import_2.Component(selector: 'team-table-view', templateUrl: 'packages/fremad/components/team/table_view.html', useShadowDom: false),
  ],
  import_0.ShowAdminArticlesComponent: const [
    const import_2.Component(selector: 'admin-articles-view', templateUrl: 'packages/fremad/components/admin/articles_view.html', useShadowDom: false),
  ],
  import_0.ShowAdminPlayersComponent: const [
    const import_2.Component(selector: 'admin-players-view', templateUrl: 'packages/fremad/components/admin/players_view.html', useShadowDom: false),
  ],
  import_0.ShowAdminMatchesComponent: const [
    const import_2.Component(selector: 'admin-matches-view', templateUrl: 'packages/fremad/components/admin/matches_view.html', useShadowDom: false),
  ],
  import_0.ShowAdminTeamsComponent: const [
    const import_2.Component(selector: 'admin-teams-view', templateUrl: 'packages/fremad/components/admin/teams_view.html', cssUrl: 'packages/fremad/components/admin/teams_view.css', useShadowDom: false),
  ],
  import_0.Messages: const [
    const import_1.Injectable(),
  ],
